...
As of `v1.0.x` the arguments are:
...
Options:
  ...
  -o, --owner-address <address>                Contract address that will own the deployed artifacts after the script
                                               runs. If --wormhole-enable is set, this setting will be ignored, and the
                                               owner will be set to the receiver
  ...
  -c, --confirmations <number>                 How many confirmations to wait for after each transaction (optional)
                                               (default: "2")
  -wh, --wormhole-enable                       Whether or not to enable Wormhole for the deployment. Wormhole settings
                                               are ignored unless this is set to true (default: false)
  --wormhole-chain-id <number>                 Chain ID to configure wormhole using (default: "1")
  --wormhole-bridge-address <address>          Address of the Wormhole bridge (default: "")
  --wormhole-receiver-address <address>        Address of the Wormhole receiver (default: "")
  --wormhole-receiver-deploy                   If true, deploy a Wormhole receiver. The setting is ignored if
                                               --wormhole-receiver-address is set (default: false)
  --wormhole-message-sender-address <address>  Address of the Wormhole message sender. Required if
                                               --wormhole-receiver-deploy is set (default: "")
